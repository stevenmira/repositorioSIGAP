...
<section class="content-header">
  ...
  <h1 align="center">REPORTE GENERAL DE CARTERAS DE CLIENTES EXTENDIDO</h1>
  <br>

  {!!Form::open(array('url'=>'cartera/cliente/extendido','method'=>'POST','autocomplete'=>'off'))!!}
  {{Form::token()}}
...
@endif
  ...
  <div class="row">
    ...
    @include('Estrategicos.carteraClienteExtendido.modal')
  </div>
  <br><br>
  {!!Form::close()!!}
