...
<section class="content-header">
  ...
  <h1 align="center">CONTRATOS VENCIDOS POR CARTERA DE CLIENTES</h1>
  <br>

  {!!Form::open(array('url'=>'contrato/vencidos','method'=>'POST','autocomplete'=>'off'))!!}
  {{Form::token()}}
...
@endif
  ...
  <div class="row">
    ...
    @include('Tacticos.contratoVencido.modal')
  </div>
  <br><br>
  {!!Form::close()!!}
