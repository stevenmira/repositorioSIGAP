...
<section class="content-header">
  ...
  <h1 align="center">REPORTE DE CLIENTES MOROSOS</h1>
  <br>

  {!!Form::open(array('url'=>'control/clienteMoroso','method'=>'POST','autocomplete'=>'off'))!!}
  {{Form::token()}}
...
@endif
  ...
  <div class="row">
    ...
    @include('Tacticos.clientesMorosos.modal')
  </div>
  <br><br>
  {!!Form::close()!!}
