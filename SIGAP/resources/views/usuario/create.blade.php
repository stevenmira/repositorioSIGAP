      ...
      <div class="panel-body">
          ...
          <div class="row"> 
            ...
            <div class="form-group col-md-4">
              ...
              <div class="input-group">
                ...
                {!! Form::text('name', null, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Introduzca el username . . .', 'autofocus'=>'on', 'maxlength'=>'30']) !!}
              </div>
            </div>
            <div class="form-group col-md-4">
              <label for="cartera">Rol de Usuario</label>
              {{ Form::select('idtipousuario', $tipousuario->pluck('nombre','idtipousuario'), null, ['class'=>'form-control','required' => 'required', 'placeholder'=>'-- Seleccione un Tipo de usuario --']) }}
            </div>
          ...
          <div class="form-group col-md-4">
              ...
              <div class="input-group">
                ...
                {!! Form::email('email', null, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Introduzca el apellido . . .', 'autofocus'=>'on', 'maxlength'=>'30']) !!}
              </div>
            </div>
            <div class="form-group col-md-4">
              ...
              <div class="input-group">
                ...
                {!! Form::password('password',['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Introduzca una  contraseña . . .', 'autofocus'=>'on','pattern'=>'[A-Za-z][A-Za-z0-9]*[0-9][A-Za-z0-9]*','title'=>'Para que la contraseña sea valida, debe comenzar con una letra, llevar una letra Mayuscula y minuscula, tener un min de 8 caracteres' ,'minlength'=>'8','maxlength'=>'30']) !!}</div>
            </div>
            <div class="row">
